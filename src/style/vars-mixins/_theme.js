...
export const gradients = {
	...
	mintVio: "linear-gradient(264.41deg, rgba(2, 20, 68, 0.5) 23.72%, rgba(156, 33, 170, 0.5) 58.6%), linear-gradient(95.59deg, #0BA1AB 23.27%, #591361 71.56%)",
	bluePink: "linear-gradient(262.61deg, rgba(8, 18, 44, 0.5) 23.1%, rgba(144, 9, 159, 0.5) 60.52%), linear-gradient(95.07deg, #0A1C4D 20.34%, #591361 59.3%)",
	pinkBlue: "linear-gradient(261.3deg, rgba(15, 56, 160, 0.5) 25.17%, rgba(109, 35, 118, 0.5) 61.87%), linear-gradient(142deg, #0B37A9 23.31%, #A700BB 87.53%)",
	vioPistachio: "linear-gradient(261.37deg, rgba(7, 62, 72, 0.5) 22.68%, rgba(107, 26, 120, 0.5) 59.12%), linear-gradient(110.99deg, #012228 26.04%, #7D790B 75.52%)",
	pearl: "linear-gradient(97.39deg, rgba(11, 137, 146, 0.5) 26.58%, rgba(89, 19, 97, 0.5) 73.91%), linear-gradient(206.93deg, rgba(23, 216, 228, 0.5) 21.9%, rgba(89, 19, 97, 0.5) 96.3%), linear-gradient(105.43deg, #591361 13.5%, rgba(89, 19, 97, 0) 38.06%)",
	orangeVio: "linear-gradient(264.41deg, rgba(135, 73, 38, 0.5) 18.17%, rgba(89, 19, 97, 0.5) 58.6%), linear-gradient(98.47deg, #E96200 17.95%, #591361 68.39%)",
	redGreen: "linear-gradient(256.65deg, rgba(3, 151, 0, 0.5) 34.2%, rgba(89, 19, 97, 0.5) 69.17%), linear-gradient(98.47deg, #BD4F00 17.95%, #830D91 68.39%)",
